...
Author: Rudram Joshi(Only getConnections method added)
...
class Graph:
    ...
    def getConnections(self, key):
        """
        Return the id of vertex identifiers in the graph.
        :return: A list of vertex id
        """

        return [vertex.id for vertex in self.vertList[key].getConnections()]
